        ...
        <View className="flex-col p-6 space-y-6 flex-1">
          ...
          <View className="flex-row justify-between mt-8 px-2">
            {otp.map((digit, index) => (
              <TextInput
                ...
                className="text-center text-2xl font-worksans-bold"
                style={{
                  width: 50,
                  height: 60,
                  borderWidth: 2,
                  borderColor: digit ? '#B8926A' : error ? '#EF4444' : '#E5E5E5',
                  borderRadius: 12,
          ...
          {isLoading ? (
            ...
            <View className="bg-green-50 rounded-xl py-3 items-center">
              <Text className="text-green-600 text-sm font-worksans-medium">
