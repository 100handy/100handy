          ...
          {is2FAEnabled ? (
            ...
            <>
              ...
              <View className="bg-green-50 border border-green-200 rounded-xl p-4">
                <View className="flex-row items-center gap-3">
                  ...
                  <View className="flex-col flex-1">
                    <Text className="text-base font-worksans-semibold text-green-800 mb-1">
                      Two-Factor Authentication Enabled
                    </Text>
                    <Text className="text-sm font-worksans text-green-600">
              ...
              <View className="flex-col space-y-4">
                <Text className="text-2xl font-worksans-bold text-gray-800">Account Security</Text>
              ...
              <View className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <View className="flex-row items-center gap-3">
                  ...
                  <View className="flex-col flex-1">
                    ...
                    <Text className="text-base font-worksans-semibold text-gray-800">{user?.email}</Text>
                  </View>
                </View>
              </View>
              ...
              >
                {isLoading ? (
                  <View className="flex-row items-center gap-2">
                    ...
                    <Text className="text-white text-lg font-worksans-bold">Processing...</Text>
                  </View>
                ) : (
                  <View className="flex-row items-center gap-2">
                    <ShieldOff size={20} color="white" />
                    <Text className="text-white text-lg font-worksans-bold">Disable Two-Factor Authentication</Text>
                  </View>
                )}
              </Pressable>
            </>
            ...
            <>
              <View className="flex-col space-y-4">
                <Text className="text-2xl font-worksans-bold text-gray-800">Two-factor authentication</Text>
                <Text className="text-base font-worksans text-gray-600">
              ...
              >
                {isLoading ? (
                  <View className="flex-row items-center gap-2">
                    <ActivityIndicator size="small" color="white" />
                    <Text className="text-white text-lg font-worksans-bold">Sending...</Text>
                  </View>
                ) : (
                  <View className="flex-row items-center gap-2">
                    <Shield size={20} color="white" />
                    <Text className="text-white text-lg font-worksans-bold">Enable Two-Factor Authentication</Text>
                  </View>
                )}
              </Pressable>
            </>
