...
const SCREEN_DEFINITIONS: AppScreenDefinition[] = [
  ...
  },
  {
    ...
    description: 'Client profile sign-in, loading, referral, and verification copy.',
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { section_key: 'toggle_data', field_key: 'title', label: 'Diagnostics title', defaultValue: 'Optional Diagnostics' },
      { section_key: 'toggle_data', field_key: 'body', label: 'Diagnostics body', defaultValue: 'Allow app diagnostics that help us improve reliability and performance' },
