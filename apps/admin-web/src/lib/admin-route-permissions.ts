...
export const ADMIN_ROUTE_PERMISSIONS: Record<AdminRouteKey, AdminRoutePermissionEntry> = {
  ...
  userAddRedirect: { path: '/users/add', permissions: ['users.manage'], section: 'users' },
  userRemoveRedirect: { path: '/users/remove', permissions: ['users.manage'], section: 'users' },
  ...
  taskDetails: { path: '/tasks/details/:taskId', permissions: ['tasks.manage'], section: 'tasks' },
  taskEditRedirect: { path: '/tasks/edit/:id', permissions: ['tasks.manage'], section: 'tasks' },
  taskRescheduleRedirect: { path: '/tasks/reschedule/:id', permissions: ['tasks.manage'], section: 'tasks' },
  taskCancelRedirect: { path: '/tasks/cancel/:id', permissions: ['tasks.manage'], section: 'tasks' },
  ...
  handyProfile: { path: '/handys/:userId', permissions: ['handys.manage'], section: 'handys' },
  ...
  contentPagesCreateRedirect: { path: '/content/pages/create', permissions: ['content.manage', 'seo.manage'], section: 'content' },
  contentPageEditor: { path: '/content/pages/:pageKey', permissions: ['content.manage', 'seo.manage'], section: 'content' },
  ...
  accountsLocationRedirect: { path: '/accounts/location', permissions: ['locations.manage'], section: 'accounts' },
