...
export default function HeaderClient({ currentPage, signedOutLinks, proCta }: HeaderProps) {
          ...
          {isSignedIn ? (
            ...
            <nav className="hidden md:flex items-center gap-4 lg:gap-6">
              ...
              <Button variant="terracotta" size="sm" asChild>
                <Link href={proCta.href}>{proCta.label}</Link>
              </Button>
            </nav>
          )}
            ...
            {isSignedIn ? (
              ...
              <>
                ...
                <Button variant="terracotta" size="sm" asChild className="mt-2 text-center">
                  <Link href={proCta.href} onClick={closeMobile}>{proCta.label}</Link>
                </Button>
              </>
            )}
          </div>
