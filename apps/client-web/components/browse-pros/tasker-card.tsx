        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col items-center gap-3 flex-shrink-0">
            ...
            <Link
              ...
              className="text-brand-terracotta text-sm font-medium hover:underline whitespace-nowrap text-center"
            >
              View Profile &<br />Reviews
            </Link>
            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-brand-terracotta text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-brand-terracotta/85 transition-colors whitespace-nowrap"
            >
              Select & Continue
            </button>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-start justify-between mb-2">
              <h3 className="text-brand-dark text-2xl font-semibold">
                {displayName}
              </h3>
              <div className="text-brand-dark text-2xl font-semibold">
                £{hourlyRate.toFixed(2)} /hr
              </div>
            </div>

            {/* Minimum Hours Badge */}
            <div className="inline-flex items-center bg-green-500 text-white px-3 py-1 rounded text-xs font-semibold mb-3">
            ...
            {handyman.bio && (
              <div className="mb-4">
                <h4 className="text-brand-dark text-base font-semibold mb-2">
                  How I can help:
                </h4>
                <p className="text-brand-dark text-sm leading-relaxed mb-1">
                  {handyman.bio}
                </p>
                <button className="text-brand-dark text-sm font-semibold hover:text-brand-terracotta">
                  Read More
                </button>
              </div>
            )}
